...
const FriendItem = ({ name, imgSrc }) => (
  <div className="bg-[#182637] SelectedItem flex items-center space-x-4 p-2 rounded-md cursor-pointer">
...
const RightSidebar = () => {
  ...
  return (
    <div className="bg-[#182637] w-64 h-screen p-4 fixed right-0 top-0 mt-16">
