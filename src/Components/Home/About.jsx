    ...
    return (
        <div className='bg-[#182637] min-h-screen flex flex-col justify-center items-center pb-10 mt-5 px-4'>
            <div className='w-full max-w-4xl text-center'>
                ...
                <p className='text-gray-300 mb-6 text-justify' style={{ whiteSpace: 'pre-line' }}>{constants.descripcion}</p>

                <div className='w-full max-w-3xl mb-8 flex flex-col md:flex-row items-center'>
                    <img src='/media/picture/asetback.jpg' alt='Backend' className='w-60 h-60 rounded-3xl mr-0 md:mr-8 mb-4 md:mb-0' />
                    <div>
                ...
                <div className='w-full max-w-3xl flex flex-col md:flex-row items-center'>
                    <div className='text-justify'>
                        <h2 className='text-lg md:text-xl text-white text-center mb-2 underline font-bold'>Frontend</h2>
                    ...
                    <img src='/media/picture/asetfront.jpg' alt='Frontend' className='w-60 h-60 ml-0 md:ml-4 rounded-3xl mt-4 md:mt-0' />
                </div>

                <p className='text-base md:text-lg text-justify pt-6 text-gray-300 mb-6'>
