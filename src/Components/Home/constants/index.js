export const constants = {
   ...
   "descripcion": "Este proyecto, desarrollado en el curso de Estructuras de Datos y Algoritmos 2, consiste en un foro web de uso libre donde\n los usuarios pueden registrarse, crear publicaciones y participar en discusiones sobre diversos temas.\nPara organizar los datos y optimizar el rendimiento, se han implementado varias estructuras de datos clave:\n 1) Las filas se utilizan para gestionar la lista de usuarios, presentando siempre al primer usuario registrado en primer lugar\n y añadiendo los nuevos al final, manteniendo el orden cronológico de registros.\n2) Los árboles se emplean en los comentarios y respuestas, permitiendo representar de forma jerárquica la relación \nentre comentarios principales y sus respuestas.\n 3) Las pilas se utilizan en los posts, donde el último en entrar es el primero en salir, facilitando una estructura\n de tipo LIFO (Last In, First Out) para el contenido de las publicaciones recientes.\nEstas estructuras de datos proporcionan un marco organizado que hace más eficiente la interacción \nde los usuarios dentro del foro.",
   "tecnologias": {
        "backend": {
